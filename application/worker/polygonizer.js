( function ( ) {
	...
	var computeTriangles = function ( data, width, height, depth ) {
	...
	var buildGeometry = function ( triangles ) {
		...
		//self.postMessage( [ triangles.length ] );
	...
	self.addEventListener( 'message', function ( e ) {
		...
		case 'polygonize':
		    ...
		    var triangles = computeTriangles( data, width, height, depth );
			var geometry = buildGeometry( triangles );
